...
In this report, we have analyzed the provided data to determine the activity performed by an individual.To do this we made use of caret and randomForest, this allowed me to generate correct answers for each of the 20 test data cases provided in this assignment. 
...
The data provided from source: http://groupware.les.inf.puc-rio.br/har is loaded into RStudio with the provided training and testing splits provided in Coursera website. Some values contained a "#DIV/0!" that I replaced with an NA value.
...
The last 8 columns are caseted to be numeric.
